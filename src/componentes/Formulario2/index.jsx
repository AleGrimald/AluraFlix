...
const Formulario2 = (props)=>{
    ...
    return(
        <form onReset={limpiarInputs} onSubmit={manejarEnvio} className="form">
            ...
            <Campo className="form__inp" type="text" placeholder="Nombre" required={true} valor={titulo} actualizarValor={setTitulo}/>
            <Textarea className="form__txtarea" placeholder="Descripcion"valor={descripcion} actualizarValor ={setDescripcion}/>
            <input className="form__color" type="color"/>
            <Campo className="form__inp" type="text" placeholder="Codigo de seguridad" required={true}valor={codigo} actualizarValor ={setCodigo}/>
